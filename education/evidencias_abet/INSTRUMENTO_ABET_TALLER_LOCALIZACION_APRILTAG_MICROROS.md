...
| **Nombre del Archivo de Entrega** | `C1_T_APRILTAG_G<grupo>_<codigo1>_<codigo2>_v1.docx` |
...
| **Momento de medición** | Primer corte, tras la ejecución de las fases de detección visual, homografía y lazo embebido en ESP32. |
